...
- [ ] Rename "Hero" into "Home"

## Hero Section (/components/Hero.tsx)
### Taglines
- [ ] Include your full name prominently in or right above the main tagline
  - "Mikhail Joseph Agudo" as a big text or part of the headline.
- [ ] Replace current tagline ("Optimizing the Future with AI and the Web") with something more specific and benefit-focused
  - Replace with "AI-Powered Automation for Tomorrow's Businesses"
- [ ] Keep the subtitle descriptive but make it punchier (replace "AI Automation Engineer specializing in Oracle HCM Cloud, integrations, and workflow optimization with LLMs")
  - Replace with "Freelance AI Automation Engineer | LLM-Driven Integration Specialist | Oracle Integrations & Analytics Expert"
- [ ] Add a short 1–2 sentence personal value statement right below the subtitle
  Example:  
...
- [ ] Keep "Get in Touch" button (showing email) — it's good
- [ ] Rename "View My Work" to "See My Experience"  
